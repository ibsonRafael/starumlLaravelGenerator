Laravel 5.X generator extension for StarUML 2
============================

This extension for StarUML(http://staruml.io) support to generate Laravel/PHP code from UML model. Install this extension from Extension Manager of StarUML.

PHP Code Generation
--------------------

1. Click the menu (`Tools > Laravel 5.X > Generate Code...`)
2. Select a base model (or package) that will be generated to Laravel/PHP.
3. Select a folder where generated Laravel/PHP source files will be placed.
